...
export default function TeacherSyllabusPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <div>
      ...
      <div className="p-6">
        <button onClick={() => router.push("/teachers")} className="text-blue-600 hover:text-blue-800 text-sm mb-2 inline-block">
        ...
        {loading ? (
          ...
          <div className="text-center py-16 bg-white rounded-xl border border-gray-200">
            <p className="text-gray-500 text-lg mb-2">No chapters assigned to this teacher</p>
            <p className="text-gray-400 text-sm">Go to a syllabus detail page to assign chapters to this teacher.</p>
          </div>
        ) : (
